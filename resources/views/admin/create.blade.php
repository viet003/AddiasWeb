            ...
            <div class="card-body">
                <form action="{{ route('dishes.store') }}" method="post">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control @error('quantity') is-invalid @enderror" id="tag" name="tag" value="{{ old('tag') }}">
                            @if ($errors->has('tag'))
                    ...
                    <div class="mb-3 row">
                        <input type="submit" class="col-md-3 offset-md-5 btn btn-primary" value="Add Dish">
                    </div>
